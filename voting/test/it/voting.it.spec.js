...
describe("voting contracts on orbs and ethereum", async () => {
    ...
    it("perform time based elections", async () => {
        ...
        console.log("Start First Election");
        ...
        const mirrorPeriodEndBlock = await electionContracts.markMirrorPeriodOver();
        await electionContracts.waitForOrbsFinality(mirrorPeriodEndBlock);
        ...
        const mirrorPeriodEndBlock2 = await electionContracts.markMirrorPeriodOver();
        ...
        expect(winners2).to.have.members([v3, v2, v4, v5].map(v => v.orbsAccount.address)); // TODO - which should be voted in???
